...
class ServerForm(FlaskForm):
    ...
    max_peers = IntegerField('Max Clients', validators=[Optional(), NumberRange(min=1)])
    ...
    api_path = StringField('API Path', default='/status', validators=[Length(max=255)])
    skip_api_check = BooleanField('Skip API Check', default=False)
